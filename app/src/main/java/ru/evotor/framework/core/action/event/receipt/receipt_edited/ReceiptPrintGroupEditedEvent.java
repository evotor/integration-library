...
public class ReceiptPrintGroupEditedEvent extends ReceiptEvent {
    public static final String BROADCAST_ACTION_SELL_RECEIPT_PRINT_GROUP_EDITED = "evotor.intent.action.receipt.sell.printGroup.EDITED";
    public static final String BROADCAST_ACTION_PAYBACK_PRINT_GROUP_EDITED = "evotor.intent.action.receipt.payback.printGroup.EDITED";
