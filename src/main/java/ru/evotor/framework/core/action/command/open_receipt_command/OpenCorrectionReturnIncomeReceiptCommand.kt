...
/**
 * Команда открытия чека коррекции возврата прихода
...
class OpenCorrectionReturnIncomeReceiptCommand(
    ...
    companion object {
        const val NAME = "evo.v2.receipt.correction.return.income.openReceipt"
        ...
        @JvmStatic
        fun create(bundle: Bundle?): OpenCorrectionReturnIncomeReceiptCommand? {
            return bundle?.let {
                OpenCorrectionReturnIncomeReceiptCommand(
