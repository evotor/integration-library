...
object PrintZReportCommandErrorDataFactory {
    ...
    @JvmStatic
    fun create(data: Bundle?): PrintZReportCommandErrorData? {
    ...
    fun toData(data: PrintZReportCommandErrorData): Bundle {
        return when (data) {
            is PrintZReportCommandErrorData.KktError -> KktErrorFactory.toData(data)
        }
    }
    ...
    private object KktErrorFactory {
        ...
        fun toData(data: PrintZReportCommandErrorData.KktError): Bundle {
            return Bundle().apply {
