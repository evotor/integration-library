...
object PrintGroupSubTable {
    ...
    const val COLUMN_PURCHASER_INN_NUMBER = "PURCHASER_INN_NUMBER"
    const val COLUMN_PURCHASER_BIRTH_DATE = "PURCHASER_BIRTH_DATE"
    const val COLUMN_PURCHASER_DOCUMENT_TYPE_CODE = "PURCHASER_DOCUMENT_TYPE_CODE"
    const val COLUMN_PURCHASER_TYPE = "PURCHASER_TYPE"
    const val COLUMN_FISCAL_SIGN_OF_INCORRECT_RECEIPT = "FISCAL_SIGN_OF_INCORRECT_RECEIPT"
}
