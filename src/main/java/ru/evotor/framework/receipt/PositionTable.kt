...
object PositionTable {
    ...
    const val COLUMN_PREFERENTIAL_MEDICINE = "PREFERENTIAL_MEDICINE"
    const val COLUMN_PREFERENTIAL_MEDICINE_AMOUNT = "PREFERENTIAL_MEDICINE_AMOUNT"
    ...
    const val COLUMN_IS_EXCISABLE = "IS_EXCISABLE"
    const val COLUMN_MARKS_CHECKING_INFO_CHECK_ID = "MARKS_CHECKING_INFO_CHECK_ID"
    const val COLUMN_MARKS_CHECKING_INFO_CHECK_TIMESTAMP = "MARKS_CHECKING_INFO_CHECK_TIMESTAMP"
    const val COLUMN_IS_MARK_SKIPPED = "IS_MARK_SKIPPED"
    const val COLUMN_IS_AGE_LIMITED: String = "IS_AGE_LIMITED"
    const val COLUMN_VETERINARY_DOCUMENT_NUMBER = "VETERINARY_DOCUMENT_NUMBER"
    const val COLUMN_VETERINARY_DOCUMENT_DATE = "VETERINARY_DOCUMENT_DATE"
    const val COLUMN_VETERINARY_DOCUMENT_TYPE = "VETERINARY_DOCUMENT_TYPE"
    const val COLUMN_VOLUME_SORT_ACCOUNTING_CLASS = "VOLUME_SORT_ACCOUNTING_QUANTITY_CLASS"
    ...
    const val COLUMN_VOLUME_SORT_ACCOUNTING_REALIZATION_TYPE = "VOLUME_SORT_ACCOUNTING_REALIZATION_TYPE"
