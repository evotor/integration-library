...
abstract class CorrectionReturnIncomeIntegrationService : IntegrationServiceV2() {
    ...
    companion object {
         ...
         *
         * Чтобы подписать службу на получение запроса, в манифесте приложения, в элементе `action` intent-фильтра службы, укажите значение `ru.evotor.event.correction.return_income.PURCHASER_REQUISITES`.
         */
        ...
        const val ACTION_INTERNET_REQUISITES = "ru.evotor.event.correction_return_income.INTERNET_REQUISITES"
