...
abstract class CorrectionOutcomeIntegrationService : IntegrationServiceV2() {
    ...
    companion object {
         ...
         *
         * Чтобы выдать разрешение, в элементе `uses-permission` манифеста приложения, укажите значение `ru.evotor.permission.CORRECTION_OUTCOME_INTEGRATION_SERVICE`.
         */
        const val PERMISSION = "ru.evotor.permission.CORRECTION_OUTCOME_INTEGRATION_SERVICE"
    }
}
