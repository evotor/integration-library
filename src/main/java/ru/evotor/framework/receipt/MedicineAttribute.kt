...
data class MedicineAttribute(
    ...
    override fun writeToParcel(dest: Parcel, flag: Int) {
        ParcelableUtils.writeExpand(dest, VERSION) { parcel ->
            ...
            parcel.writeAliased(medicineAdditionalDetails, flag)
        }
    }
    ...
    companion object {
        ...
        fun fromBundle(bundle: Bundle?): MedicineAttribute? {
            return bundle?.let {
                ...
                MedicineAttribute(
                    subjectId = subjectId,
                    preferentialMedicineType = Utils.safeValueOf(
                        PreferentialMedicineType::class.java,
                        it.getString(KEY_PREFERENTIAL_MEDICINE_TYPE),
                        null
                    ),
        ...
        private fun create(dest: Parcel): MedicineAttribute {
            ...
            ParcelableUtils.readExpand(dest, VERSION) { parcel, version ->
                ...
                if (version >= 2) {
                    ...
                    medicineAdditionalDetails = parcel.readAliased(MedicineAdditionalDetails.CREATOR)
                }
                if (version >= 3) {
