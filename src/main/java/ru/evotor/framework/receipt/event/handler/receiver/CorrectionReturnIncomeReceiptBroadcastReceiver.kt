...
/**
 * Широковещательный приёмник событий приложения "Коррекция возврата прихода".
 * @see <a href="https://developer.evotor.ru/docs/doc_java_broadcastreceiver.html">Использование широковещательного приёмника</a>
 */
open class CorrectionReturnIncomeReceiptBroadcastReceiver : ReceiptBroadcastReceiver(
    ...
    companion object {
        const val ACTION_RECEIPT_CREATED =
            "evotor.intent.action.receipt.correction.return.income.OPENED"
        const val ACTION_POSITION_ADDED =
            "evotor.intent.action.receipt.correction.return.income.POSITION_ADDED"
        const val ACTION_POSITION_UPDATED =
            "evotor.intent.action.receipt.correction.return.income.POSITION_EDITED"
        const val ACTION_POSITION_REMOVED =
            "evotor.intent.action.receipt.correction.return.income.POSITION_REMOVED"
        const val ACTION_APPLY_DISCOUNT_TO_RECEIPT =
            "evotor.intent.action.receipt.correction.return.income.APPLY_DISCOUNT_TO_RECEIPT"
