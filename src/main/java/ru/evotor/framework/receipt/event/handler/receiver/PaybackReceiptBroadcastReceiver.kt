...
open class PaybackReceiptBroadcastReceiver : ReceiptBroadcastReceiver(
    ...
    companion object {
        ...
        const val ACTION_POSITION_CHANGED = "evotor.intent.action.receipt.payback.POSITION_EDITED"
        ...
        const val ACTION_RECEIPT_DELETED = "evotor.intent.action.receipt.payback.CLOSED"
