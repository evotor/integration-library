...
/**
 * Широковещательный приёмник событий приложения "Коррекция прихода".
 * @see <a href="https://developer.evotor.ru/docs/doc_java_broadcastreceiver.html">Использование широковещательного приёмника</a>
 */
open class CorrectionIncomeReceiptBroadcastReceiver : ReceiptBroadcastReceiver(
    ...
    companion object {
        const val ACTION_RECEIPT_CREATED =
            "evotor.intent.action.receipt.correction.income.OPENED"
        const val ACTION_POSITION_ADDED =
            "evotor.intent.action.receipt.correction.income.POSITION_ADDED"
        const val ACTION_POSITION_UPDATED =
            "evotor.intent.action.receipt.correction.income.POSITION_EDITED"
        const val ACTION_POSITION_REMOVED =
            "evotor.intent.action.receipt.correction.income.POSITION_REMOVED"
        const val ACTION_APPLY_DISCOUNT_TO_RECEIPT =
            "evotor.intent.action.receipt.correction.income.APPLY_DISCOUNT_TO_RECEIPT"
        const val ACTION_RECEIPT_DELETED =
            "evotor.intent.action.receipt.correction.income.CLEARED"
        const val ACTION_RECEIPT_COMPLETED =
            "evotor.intent.action.receipt.correction.income.RECEIPT_CLOSED"
        const val ACTION_RECEIPT_EDIT_SCREEN_OPENED =
            "evotor.intent.action.receipt.correction.income.EDIT_SCREEN_OPENED"
        const val ACTION_RECEIPT_PAYMENT_SCREEN_OPENED =
            "evotor.intent.action.receipt.correction.income.PAYMENT_SCREEN_OPENED"
    }
}
