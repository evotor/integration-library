...
open class CorrectionOutcomeReceiptBroadcastReceiver : ReceiptBroadcastReceiver(
    ...
    companion object {
        const val ACTION_RECEIPT_CREATED =
            "evotor.intent.action.receipt.correction.outcome.OPENED"
        const val ACTION_POSITION_ADDED =
            "evotor.intent.action.receipt.correction.outcome.POSITION_ADDED"
        const val ACTION_POSITION_UPDATED =
            "evotor.intent.action.receipt.correction.outcome.POSITION_EDITED"
        const val ACTION_POSITION_REMOVED =
            "evotor.intent.action.receipt.correction.outcome.POSITION_REMOVED"
        const val ACTION_APPLY_DISCOUNT_TO_RECEIPT =
            "evotor.intent.action.receipt.correction.outcome.APPLY_DISCOUNT_TO_RECEIPT"
        const val ACTION_RECEIPT_DELETED =
            "evotor.intent.action.receipt.correction.outcome.CLEARED"
        const val ACTION_RECEIPT_COMPLETED =
            "evotor.intent.action.receipt.correction.outcome.RECEIPT_CLOSED"
        const val ACTION_RECEIPT_EDIT_SCREEN_OPENED =
            "evotor.intent.action.receipt.correction.outcome.EDIT_SCREEN_OPENED"
        const val ACTION_RECEIPT_PAYMENT_SCREEN_OPENED =
            "evotor.intent.action.receipt.correction.outcome.PAYMENT_SCREEN_OPENED"
    }
}
