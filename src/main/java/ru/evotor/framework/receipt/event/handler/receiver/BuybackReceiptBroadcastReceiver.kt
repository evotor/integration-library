...
open class BuybackReceiptBroadcastReceiver : ReceiptBroadcastReceiver(
    ...
    companion object {
        const val ACTION_RECEIPT_CREATED = "evotor.intent.action.receipt.buyback.OPENED"
        ...
        const val ACTION_APPLY_DISCOUNT_TO_RECEIPT = "evotor.intent.action.receipt.buyback.APPLY_DISCOUNT_TO_RECEIPT"
        ...
        const val ACTION_RECEIPT_EDIT_SCREEN_OPENED = "evotor.intent.action.receipt.buyback.EDIT_SCREEN_OPENED"

        const val ACTION_RECEIPT_PAYMENT_SCREEN_OPENED = "evotor.intent.action.receipt.buyback.PAYMENT_SCREEN_OPENED"
    }
}
