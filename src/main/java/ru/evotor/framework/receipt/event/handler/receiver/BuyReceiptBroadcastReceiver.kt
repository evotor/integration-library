...
open class BuyReceiptBroadcastReceiver : ReceiptBroadcastReceiver(
    ...
    companion object {
        ...
        const val ACTION_POSITION_CHANGED = "evotor.intent.action.receipt.buy.POSITION_EDITED"
        ...
        const val ACTION_RECEIPT_DELETED = "evotor.intent.action.receipt.buy.CLOSED"
