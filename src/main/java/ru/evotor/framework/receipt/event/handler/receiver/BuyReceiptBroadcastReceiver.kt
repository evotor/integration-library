...
open class BuyReceiptBroadcastReceiver : ReceiptBroadcastReceiver(
    ...
    companion object {
        ...
        const val ACTION_RECEIPT_EDIT_SCREEN_OPENED = "evotor.intent.action.receipt.buy.EDIT_SCREEN_OPENED"

        const val ACTION_RECEIPT_PAYMENT_SCREEN_OPENED = "evotor.intent.action.receipt.buy.PAYMENT_SCREEN_OPENED"
    }
}
