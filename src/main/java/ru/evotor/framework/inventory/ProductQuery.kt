...
class ProductQuery : FilterBuilder<ProductQuery, ProductQuery.SortOrder, ProductItem?>(ProductTable.URI) {
    ...
    @JvmField
    val procurementPrice = addFieldFilter<BigDecimal, BigDecimal>(ProductTable.ROW_PROCUREMENT_PRICE, {it.multiply(BigDecimal(100))})
    @JvmField
    ...
    class SortOrder : FilterBuilder.SortOrder<SortOrder>() {
        ...
        @JvmField
        val procurementPrice = addFieldSorter(ProductTable.ROW_PROCUREMENT_PRICE)
        @JvmField
